...
Shipment Details Are Displayed
...
shipment-tracking/ │── logistic_control/ # Django Project │ ├── settings.py # Django settings │ ├── urls.py # URL Routing │ ├── wsgi.py # WSGI Application │── tracking_system/ # Main Django App │ ├── views.py # Backend logic │ ├── models.py # Database models │ ├── templates/ # HTML Templates │ ├── migrations/ # Database migrations │── static/ # CSS, JavaScript, and static files │── db.sqlite3 # Database │── manage.py # Django Management Script │── README.md # Project Documentation
